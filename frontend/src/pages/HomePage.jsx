...
function HomePage() {
  const homeSchema = {
    ...
    "description": "The ultimate platform for collaborative coding interviews and pair programming.",
    "offers": {
      "@type": "Offer",
      "price": "0",
      "priceCurrency": "USD"
  ...
  return (
    <div className="bg-linear-to-br from-base-100 via-base-200 to-base-300 min-h-screen">
      <SEO 
        ...
        url="https://devevaluate.com/"
        schema={homeSchema}
      />
      {/* HEADER / NAVBAR */}
      <header className="bg-base-100/80 backdrop-blur-md border-b border-primary/20 sticky top-0 z-50 shadow-lg">
      ...
      <main>
      {/* HERO SECTION */}
      <section aria-label="Hero" className="max-w-7xl mx-auto px-4 py-20">
      ...
      {/* FEATURES SECTION */}
      <section aria-label="Features" className="max-w-7xl mx-auto px-4 py-20">
